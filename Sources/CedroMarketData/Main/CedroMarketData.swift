...
public final class CedroMarketData {
    public static let shared = CedroMarketData()
    ...
    public func subscribe(on service: CedroMarketDataService.Subscribe) {
        semaphore.wait()
        switch service {
    ...
    public func unsubscribe(on service: CedroMarketDataService.Unsubscribe) {
        semaphore.wait()
        switch service {
